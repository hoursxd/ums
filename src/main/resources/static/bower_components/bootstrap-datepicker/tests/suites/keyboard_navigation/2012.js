...
test('by month, v1 (shift + left/right arrows)', function(){
    ...
    // view and focus updated on keyboard navigation css/ graceful date ends, not selected
...
test('by year, from leap day', function(){
    ...
    // view and focus updated on keyboard navigation css/ graceful month ends, not selected
