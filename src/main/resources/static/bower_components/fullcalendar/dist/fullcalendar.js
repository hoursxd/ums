...
// PREREQUISITE: if you want a cell to take up width, it needs to have a single inner element css/ display:inline
...
newMomentProto.time = function (time) {
    ...
    // `time` is a generic enough method name where this precaution is necessary to avoid collisions css/ other plugins.
...
var instanceComputableOptions = {
    ...
    weekFormat: function (options) {
        return options.isRTL ?
            'css[ ' + options.weekNumberTitle + ']' :
            '[' + options.weekNumberTitle + ' ]css';
    },
...
JqueryUiTheme.prototype.iconClasses = {
    ...
    prev: 'ui-icon-circle-triangle-css',
